...
get_sbo_kgramfreqsC <- function(sentences, N, dict) {
    .Call(`_sbo_get_sbo_kgramfreqsC`, sentences, N, dict)
}

get_sbo_kgramfreqs_fastC <- function(input, N, dict, erase = "[^.?!:;'\\w\\s]", lower_case = TRUE, EOS = ".?!:;") {
    .Call(`_sbo_get_sbo_kgramfreqs_fastC`, input, N, dict, erase, lower_case, EOS)
}
